...
### Mamba.ru (Одесса), технический директор филиала в Украине, октябрь 2011 - настоящий момент
Задачи: запустить работу офиса и собрать команду. После начала работы руководство офисом и отделом социальных приложений. Создали облачный хостинг под задачи компании с использованием:
